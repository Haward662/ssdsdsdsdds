...
echo "🚀 ПОЛНЫЙ ДЕПЛОЙ PROBOOST НА TIMEWEB CLOUD"
echo "==========================================="
echo ""
...
echo "📦 ШАГ 8: Установляю зависимости Node.js..."
...
# ═══════════════════════════════════════════════════════════════════════════
# 9. СОЗДАЁМ .ENV ФАЙЛ (ЗАПОЛНИТЬ ВРУЧНУЮ)
# ═══════════════════════════════════════════════════════════════════════════

echo "📝 ШАГ 9: Создаю .env файл..."
...
# ═══════════════════════════════════════════════════════════════════════════
# 10. NGINX КОНФИГУРАЦИЯ
# ═══════════════════════════════════════════════════════════════════════════

echo "⚙️  ШАГ 10: Настраиваю Nginx..."
...
server {
    ...
    # Остальное возвращает 404 (фронтенд на App Platform)
    location / {
        return 404;
    }
}
...
# ═══════════════════════════════════════════════════════════════════════════
# 11. ЗАПУСКАЕМ ПРИЛОЖЕНИЯ ЧЕРЕЗ PM2
# ═══════════════════════════════════════════════════════════════════════════

echo "🚀 ШАГ 11: Запускаю приложения через PM2..."
...
echo "  ✅ Certbot (SSL)"
echo "  ✅ Код из GitHub (/opt/sait-main)"
echo ""
